...
experiments=( 0 'iter_nwe_coatt' 0 'iter_nwe_coatt') # 2 'iter_nwe_coatt' 3 'iter_nwe_coatt')
...
python main.py -fold ${experiments[$((($SLURM_ARRAY_TASK_ID-1)*2))]} -train 1 -test_multi_run 1 -model_type ${experiments[$((($SLURM_ARRAY_TASK_ID-1)*2+1))]} -embed_type word2vec -data_dir /home/menna/projects/def-jag/menna/VOCdevkit/VOC2012/ -dataset_name pascal -n_shots $n_shots -bs 4 -ckpt ${experiments[$((($SLURM_ARRAY_TASK_ID-1)*2+1))]}_$SLURM_ARRAY_TASK_ID -niterations 100000 -data_aug 0 -lr 0.001
