...
for fold in {0..3}
do
	python main.py -train 0 -test_multi_run 1 -model_type iter_nwe_coatt -fold $fold -embed_type word2vec -data_dir /home/menna/projects/def-jag/menna/VOCdevkit/VOC2012/ -dataset_name pascal -n_shots 1 -bs 4 -ckpt iter_nwe_coatt
done
#done
